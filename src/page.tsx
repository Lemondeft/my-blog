        ...
        <div className="p-9 flex flex-col gap-8">
          {sortedPosts.map((post) => (
            <div
              ...
              className="post-card border border-white/40 rounded-lg p-6 hover:border-white/60 hover:shadow-[0_0_20px_rgba(100,200,255,0.1)] transition-colors cursor-pointer hover:scale-[1.01] duration-300">
